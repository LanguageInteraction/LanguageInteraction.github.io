...
In this work, we explore how contracts might move beyond static documents toward interactive systems that support users before, during, and after signing, a concept we term **Living Contracts**, which will be presented at [CHI 2026](https://chi2026.acm.org/) in Barcelona [(Preprint)](https://arxiv.org/pdf/2602.01396).


---

## Living Contracts: A Reimagination of Contract Interfaces

**Living Contracts** paints a vision for contract interfaces that go beyond static documents and instead support interaction across the full contract lifecycle before, during, and after signing. This vision is grounded in three design concepts:
...
To illustrate the vision of Living Contracts, we used residential leases as a case study and created three design probes implemented as interactive interfaces that reimagine the renting process.
...
### Challenges of Human-Contract Interaction
...
- **DC1: Educate legal rights.** In LeaseRead, Information Cards introduced legal rights in city ordinances that participants were previously unaware of and helped identify ambiguous or potentially unlawful clauses they might have otherwise overlooked. Participants felt more empowered to ask for clarification and request modifications, especially under time or social pressure.

- **DC2: Transform legal text.** Alternative representations of legal text supported challenging information tasks from comparing apartments in LeaseCompare to making sense of the contract in LeaseRead with Comics and Interactive Scenarios. 

- **DC3: Proactively supply information.** Proactively supplying contractual information could facilitate informed decision making before (e.g., selecting an apartment in LeaseCompare) and after signing (e.g., managing obligations or advocating for rights in LeaseTrack). 
